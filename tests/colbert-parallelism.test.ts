 ...
 *
 * Lives in its own file because tests/colbert.test.ts replaces `node:os`
 * with a homedir/tmpdir-only stub, which would hide the real thread count
 * this logic is entirely about.
 */
