...
//      browser + the gpt-6-luna default reachable in the catalog. With
...
// and gpt-6-luna is /responses-only.
...
describe("browse tool gate (browseAgentEnabled)", () => {
  ...
  test("tools/list OMITS `browse` when the gpt-6-luna default is absent from the catalog", async () => {
