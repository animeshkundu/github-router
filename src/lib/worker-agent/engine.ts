...
/** Default model for the READ-ONLY `explore` mode. `gpt-6-luna` at `high`
...
export const EXPLORE_DEFAULT_MODEL = "gpt-6-luna"
 ...
 *  model rather than the lightweight `gpt-6-luna` explore default. Any
