...
export const OPERATING_DEFAULTS_DIGEST =
  ...
  + "worker, or model when the work is WIDE (many files or sources to sweep) or SLOW and you need "
  + "only the conclusion, preferring parallel delegation for independent work, to protect the main "
  + "thread's finite context and keep it free for reasoning and interacting with the user; not merely "
  + "because a sub-question is separable — a narrow, deep question whose value is file:line fidelity "
  + "loses that through a summarization layer, and one answerable in a single command is cheaper done "
  + "directly. Do trivial, surgical, and last-mile work yourself. "
