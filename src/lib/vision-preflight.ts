 ...
 *   - gpt-6-sol       catalog  1 → upstream enforces 50
 *   - gpt-5.5           catalog  1 → accepted 120, no ceiling found
 *   - claude-opus-5.5     catalog  1 → accepted 200, no ceiling found
 ...
 * family: gpt-6-sol stops at 50 while gpt-5.5 took 120, which is the sharpest
