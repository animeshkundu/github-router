  ...
  return Object.freeze([
    tool(
      ...
      objectSchema({
        ...
        default_model: stringProp("Model the GitHub cloud coding agent uses for this mission's tasks; defaults to gpt-6-sol."),
        plan_gate: enumProp(
          ["hard", "soft"],
      ...
      async (args, _signal, ctx) => {
        ...
        // wake at dispatch. Unspecified → gpt-6-sol default → resolves silently.
