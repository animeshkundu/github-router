import { CHEAP_PROFILE_ADVISOR_CLIENT_MODEL } from "./cheap-profile-contract"
...
export function cheapAdvisorClientEnabled(
 ...
 */
export function withFixedCheapAdvisorArg(
  args: ReadonlyArray<string>,
  enabled = cheapAdvisorClientEnabled(),
): string[] {
  ...
  const fixed = [ADVISOR_FLAG, CHEAP_PROFILE_ADVISOR_CLIENT_MODEL]
