...
|---|---:|---|
| `claude-opus-4.6` / `4.7` / `4.8` / `5` | 1 | >= 32; `claude-opus-5.5` accepted **200**, no ceiling found |
| `claude-sonnet-4.6` / `5`, `claude-haiku-4.5` | 5 | >= 32 |
| `gpt-6-sol` | 1 | **50**, enforced exactly |
| `gpt-5.5` | 1 | accepted **120**, no ceiling found |
| `gpt-5.3-codex`, `gpt-5.4`, `gpt-5.4-mini`, `gpt-6-luna` / `terra`, `gpt-5-mini` | 1 | >= 32, not escalated further |
...
The real ceiling is **not uniform even within a family**: `gpt-6-sol` stops at
