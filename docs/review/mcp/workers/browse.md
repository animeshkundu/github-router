...
| Backing model / endpoint | `gpt-6-luna` (`BROWSE_DEFAULT_MODEL`), high thinking (`BROWSE_DEFAULT_THINKING`); routed through the same Pi worker engine as explore/review/implement |
