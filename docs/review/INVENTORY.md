...
|---|---|---|---|
| OPERATING_DEFAULTS_DIRECTIVE | `--append-system-prompt` (leads) + CLAUDE.md top | none (always pushed) | [operating-defaults-directive](./injected-prompt/operating-defaults-directive.md) |
