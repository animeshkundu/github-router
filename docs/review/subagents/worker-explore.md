...
| Subagent's OWN model | inherited (Claude — no `model:` frontmatter); the WORKER it dispatches runs `EXPLORE_DEFAULT_MODEL` = `gpt-5.6-luna` at high (repo CLAUDE.md "worker tools") |
