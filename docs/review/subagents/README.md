...
| `Explore` (native, fast only) | gpt-5.6-luna | capitalized read-only repository exploration role replacing fast `scout` | exact fast-profile prerequisite: 1M `tool_calls`, high effort, Responses endpoint | [scout.md](scout.md) | Y |
