...
| `browse` | browser-control | `gpt-6-luna` / `high` | browser tools + terminal `submit_answer` / `report_insufficient` | n/a | Drives a real browser in a sandbox and returns the requested result or a specific blocker/insufficiency report. |
